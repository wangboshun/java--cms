...
<head>
    ...
    <link rel="stylesheet" href="/resources/lib/layfly/css/global.css">
</head>
<body>
...
<div class="fly-header layui-bg-black">
    <div class="layui-container">
        <a class="fly-logo" href="/">
            <img src="/resources/lib/layfly/images/logo.png" alt="layui">
        </a>
...
<script>
    ...
    layui.cache.user = {
        username: '游客'
        , uid: -1
        , avatar: '/resources/lib/layfly/images/avatar/00.jpg'
        , experience: 83
        , sex: '男'
    };
    layui.config({
        version: "3.0.0"
        , base: '/resources/lib/layfly/js/' //这里实际使用时，建议改成绝对路径
    }).extend({
        fly: 'index'
    }).use('fly');
</script>
